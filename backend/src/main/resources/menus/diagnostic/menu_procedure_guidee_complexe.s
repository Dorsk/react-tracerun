...
<Tree chk="-1838471464" type="Tree" onEnd="default" onBackExit="back">
	...
	<cel>
		...
		<Test posc="6" posl="6" destyesc="8" destyesl="8" destnoc="22" destnol="22" ident="15"
			<Comment>Test VIN EQUAL 333333
			</Comment>
			<NamedBuffer name="VIN">
			</NamedBuffer>
		...
		<QsScreen posc="6" posl="6" destyesc="8" destyesl="8" destnoc="22" destnol="22" ident="15">
			<ScreenTitle title="Préparation du véhicule" description="Effectuer l'action avant de passer à la suite">Le buffer VIN n'est pas égale à la valeur 333333
			</ScreenTitle>
			<NamedBuffer name="VIN">
			</NamedBuffer>
		</QsScreen>
		<QsScreen posc="8" posl="8" destyesc="22" destyesl="22" destnoc="22" destnol="22" ident="16">
			<ScreenTitle title="Préparation du véhicule" description="Effectuer l'action avant de passer à la suite">Le buffer VIN est égale à la valeur 333333
			</ScreenTitle>
		</QsScreen>
